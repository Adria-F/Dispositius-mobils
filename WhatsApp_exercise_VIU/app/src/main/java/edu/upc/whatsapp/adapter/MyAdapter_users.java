...
public class MyAdapter_users extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      TextView name = (TextView)convertView.findViewById(R.id.row_twotextviews_name);
      TextView surname = (TextView)convertView.findViewById(R.id.row_twotextviews_surname);
